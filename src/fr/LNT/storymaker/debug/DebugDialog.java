...
public class DebugDialog {
	...
	public DebugDialog() {
		...
		LinkedHashMap<String, Integer> answer1 = new LinkedHashMap<>();
		answer1.put(answer[0], 2);
		answer1.put(answer[1], 3);
		answer1.put(answer[2], 4);
		
		LinkedHashMap<String, Integer> answer2 = new LinkedHashMap<>();
		answer2.put(answer[3], 6);
		answer2.put(answer[4], 5);
		answer2.put(answer[5], 6);
		
		LinkedHashMap<String, Integer> answer3 = new LinkedHashMap<>();
		answer3.put(answer[3], 5);
		answer3.put(answer[4], 6);
		answer3.put(answer[5], 6);
		
		LinkedHashMap<String, Integer> answer4 = new LinkedHashMap<>();
		answer4.put(answer[3], 6);
		answer4.put(answer[4], 6);
		answer4.put(answer[5], 5);
		
		LinkedHashMap<String, Integer> answer5 = new LinkedHashMap<>();
		answer5.put(answer[6], -1);
		
		LinkedHashMap<String, Integer> answer6 = new LinkedHashMap<>();
		answer6.put(answer[7], 1);
